  ...
  private[bearlyb] def fromInternal(internal: SDL_Event): Event =
    internal.`type`() match
      ...
      case SDL_EVENT_DISPLAY_ORIENTATION =>
        Display.Orientation(internal.deadline, internal.display.displayID)
      case SDL_EVENT_DISPLAY_ADDED =>
        Display.Added(internal.deadline, internal.display.displayID)
      case SDL_EVENT_DISPLAY_REMOVED =>
        Display.Removed(internal.deadline, internal.display.displayID)
      case SDL_EVENT_DISPLAY_MOVED =>
        Display.Moved(internal.deadline, internal.display.displayID)
      case SDL_EVENT_DISPLAY_DESKTOP_MODE_CHANGED =>
        Display.DesktopModeChanged(
          internal.deadline,
          internal.display.displayID
        )
      case SDL_EVENT_DISPLAY_CURRENT_MODE_CHANGED =>
        Display.CurrentModeChanged(
          internal.deadline,
          internal.display.displayID
        )
      case SDL_EVENT_DISPLAY_CONTENT_SCALE_CHANGED =>
        Display.ContentScaleChanged(
          internal.deadline,
          internal.display.displayID
        )
      ...
      case SDL_EVENT_WINDOW_SHOWN =>
        Window.Shown(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_HIDDEN =>
        Window.Hidden(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_EXPOSED =>
        Window.Exposed(internal.deadline, internal.window.windowID)
      ...
      case SDL_EVENT_WINDOW_METAL_VIEW_RESIZED =>
        Window.MetalViewResized(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_MINIMIZED =>
        Window.Minimized(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_MAXIMIZED =>
        Window.Maximized(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_RESTORED =>
        Window.Restored(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_MOUSE_ENTER =>
        Window.MouseEnter(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_MOUSE_LEAVE =>
        Window.MouseLeave(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_FOCUS_GAINED =>
        Window.FocusGained(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_FOCUS_LOST =>
        Window.FocusLost(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_CLOSE_REQUESTED =>
        Window.CloseRequested(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_HIT_TEST =>
        Window.HitTest(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_ICCPROF_CHANGED =>
        Window.ICCProfChanged(internal.deadline, internal.window.windowID)
      ...
      case SDL_EVENT_WINDOW_SAFE_AREA_CHANGED =>
        Window.SafeAreaChanged(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_OCCLUDED =>
        Window.Occluded(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_ENTER_FULLSCREEN =>
        Window.EnterFullscreen(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_LEAVE_FULLSCREEN =>
        Window.LeaveFullscreen(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_DESTROYED =>
        Window.Destroyed(internal.deadline, internal.window.windowID)
      case SDL_EVENT_WINDOW_HDR_STATE_CHANGED =>
        Window.HDRStateChanged(internal.deadline, internal.window.windowID)
      ...
      case SDL_EVENT_KEYMAP_CHANGED =>
        KeymapChanged(internal.deadline)
      ...
      case SDL_EVENT_TEXT_EDITING_CANDIDATES =>
        val candidateBuffer: Option[PointerBuffer] = Option(
          internal.edit_candidates.candidates
        )
        val candidateSeq: Seq[String] = candidateBuffer match
          case None => Seq.empty
          case Some(buffer) =>
            Seq.tabulate(internal.edit_candidates.num_candidates)(
      ...
      case SDL_EVENT_GAMEPAD_SENSOR_UPDATE =>
        Gamepad.SensorUpdate(
          ...
          SensorData
            .fromInternal(internal.gsensor.sensor, internal.gsensor.data),
      ...
      case SDL_EVENT_CLIPBOARD_UPDATE =>
        ...
        val mimeTypesSeq: Seq[String] = 
          Seq.tabulate(internal.clipboard.num_mime_types)(
            mimeTypesBuffer.getStringUTF8
          )
        ClipboardUpdate(internal.deadline, internal.clipboard.owner, mimeTypesSeq)
      ...
      case SDL_EVENT_CAMERA_DEVICE_ADDED =>
        CameraDevice.Added(
          internal.deadline,
          internal.cdevice.which
        )
      
      case SDL_EVENT_CAMERA_DEVICE_REMOVED =>
        CameraDevice.Removed(
          internal.deadline,
          internal.cdevice.which,
        )
      
      case SDL_EVENT_CAMERA_DEVICE_APPROVED =>
        CameraDevice.Approved(
          internal.deadline,
          internal.cdevice.which
        )
