...
object Scancode:
  ...
  */
  ...
  val NumlockClear: Scancode = 83 /**< num lock on PC, clear on Mac keyboards
                                    */
  ...
  *   layout. */
  ...
  val Application: Scancode = 101 /**< windows contextual menu, compose */
  val Power: Scancode = 102 /**< The USB document says this is a status flag,
  ...
  val Help: Scancode = 117    /**< AL Integrated Help Center */
  val Menu: Scancode = 118    /**< Menu (show menu) */
  val Select: Scancode = 119
  val Stop: Scancode = 120    /**< AC Stop */
  val Again: Scancode = 121   /**< AC Redo/Repeat */
  val Undo: Scancode = 122    /**< AC Undo */
  val Cut: Scancode = 123     /**< AC Cut */
  val Copy: Scancode = 124    /**< AC Copy */
  val Paste: Scancode = 125   /**< AC Paste */
  val Find: Scancode = 126    /**< AC Find */
  ...
  val International1: Scancode = 135 /**< used on Asian keyboards, see
                                            footnotes in USB doc */
  val International2: Scancode = 136
  val International3: Scancode = 137 /**< Yen */
  ...
  val Lang1: Scancode = 144 /**< Hangul/English toggle */
  val Lang2: Scancode = 145 /**< Hanja conversion */
  val Lang3: Scancode = 146 /**< Katakana */
  val Lang4: Scancode = 147 /**< Hiragana */
  val Lang5: Scancode = 148 /**< Zenkaku/Hankaku */
  val Lang6: Scancode = 149 /**< reserved */
  val Lang7: Scancode = 150 /**< reserved */
  val Lang8: Scancode = 151 /**< reserved */
  val Lang9: Scancode = 152 /**< reserved */

  val AltErase: Scancode = 153    /**< Erase-Eaze */
  val SysReq: Scancode = 154
  val Cancel: Scancode = 155      /**< AC Cancel */
  ...
  val Call: Scancode = 289 /**< Used for accepting phone calls. */
  val Endcall: Scancode = 290 /**< Used for rejecting phone calls. */
  ...
  extension (code: Scancode)
    private[bearlyb] def internal: Scancode = code
